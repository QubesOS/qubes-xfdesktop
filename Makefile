...
FEDORA_SOURCES := https://src.fedoraproject.org/rpms/xfdesktop/raw/f$(subst fc,,$(DIST))/f/sources
SRC_FILES := \
...
SRC_URLS := \
http://archive.xfce.org/src/xfce/xfdesktop/4.18/xfdesktop-$(VERSION).tar.bz2
